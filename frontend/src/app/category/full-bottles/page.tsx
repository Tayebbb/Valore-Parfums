      ...
      <section className="mt-7 sm:mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {perfumes.slice(0, 24).map((perfume) => (
            <Link key={perfume.id} href={buildCanonicalProductPath(perfume)} className="border border-[var(--border)] bg-[var(--bg-card)]/35 rounded px-3.5 py-2.5 hover:border-[var(--gold)] transition-colors">
